...
public class JsonUtil {
    ...
    public static <T> String toJson(final T o) throws JsonProcessingException {
        /*
         * This used to pass in false to escape, however after looking at the majority of dev,
         * we came to the consensus that the majority of uses always wanted to escape their JSON.
         */
